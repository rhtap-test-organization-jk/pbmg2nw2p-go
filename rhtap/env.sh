...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/pbmg2nw2p-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-dsm67.dsm67.sandbox46.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-dsm67.dsm67.sandbox46.opentlc.com}
